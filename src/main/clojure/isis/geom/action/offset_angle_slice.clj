(ns isis.geom.action.offset-angle-slice
  "The table of rules."
...
(def slicer "offset-angle")

(defn assemble!->t0-r0 [kb m1 m2] :consistent)
(defn assemble!->t0-r1 [kb m1 m2]  (ms/unimpl :t0-r1 slicer kb m1 m2))
(defn assemble!->t0-r2 [kb m1 m2]  (ms/unreal :t0-r2 slicer kb m1 m2))
(defn assemble!->t0-r3 [kb m1 m2]  (ms/unreal :t0-r3 slicer kb m1 m2))
