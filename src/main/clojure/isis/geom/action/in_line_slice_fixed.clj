...
(defn transform!->t0-r1 [kb m1 m2]  (ms/unimplemented slicer :t0r1) )
(defn transform!->t0-r2 [kb m1 m2]  (ms/unimplemented slicer  :t0r2) )
...
(defn transform!->t3-r3 [kb m1 m2]  (ms/unimplemented slicer  :t3r3) )
