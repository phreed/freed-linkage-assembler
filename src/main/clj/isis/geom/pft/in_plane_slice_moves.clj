...
---
PFT entry: (3,0,in-plane) (?M_1 moves)
---
...
---
PFT entry: (h,h,in-plane) (?M_1 moves)
---
...
---
PFT entry: (0,1,in-plane) (?M_1 moves)
---
...
---
PFT entry: (1,1,in-plane) (?M_1 moves)
---
...
Plan fragment:
  ...
  R[6] = perp-dist(R[4], ?point);
  R[7] = ellipse+r(R[4], gmz(?M_2), R[5]);
  end;
...
Explanation:
  ...
  then, the geom is translated and rotated to make the point
  coincident with ?M_1.
  A single degree of freedom remains, combining rotation and translation.



---
PFT entry: (2,1,in-plane)  (?M_1 moves)
---
...
---
PFT entry: (3,1,in-plane) (?M_1 moves)
---
...
---
PFT entry: (0,2,in-plane) (?M_1 moves)
---
...
---
PFT entry: (0,3,in-plane) (?M_1 moves)
---
...
Plan fragment:
  ...
  R[2] = plane(gmp(?M_2), gmz(?M_2));
  R[3] = intersect(R[1], R[2], q_0);
  // should this have a q_0, or should the value be 0?
  unless circle?(R[3])
    error(perp-dist(R[1], R[2]),
    estring[7]);
  R[4] = a-point(R[3]);

  3r/p-p(?geom, ?point, gmp(?M_1), R[4]);
